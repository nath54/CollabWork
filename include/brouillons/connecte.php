        ...
        <?php
            ...
            if(count($brouillons) == 0){
                ...
                foreach($brouillons as $br){
                    ...
                    // $text_date = "hier";
                    $text_date = $date;
                    echo "<div id='$id' class='bt_item row' style='cursor:default;'><div class='col' style='width:100%; padding:5px; margin:auto; '><h2>$titre</h2><i style='font-size:0.9em;'>Dernière modification : $text_date</i></div> <div class='row'><img class='bt_svg' src='../res/pencil.svg' onclick=\"send_form('brouillon.php', [['type', 'request'], ['brouillon_id', $id]]);\"  /> <img class='bt_svg' src='../res/trash.svg' onclick=\"send_form('../web/brouillons.php', [['type', 'delete'], ['brouillon_id', $id]]);\"/></div></div>";
                }
            }
