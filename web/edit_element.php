...
if(isset($_POST["type"]) && $_POST["type"]=="request" && isset($_POST["id_element"]) && test_token($_POST)){
    ...
    $nb_titre = count(requete_prep($db, $req, [":id_compte"=>$_SESSION["id_compte"], ":idc"=>$id_chap])) + 1;
    ...
    action_prep($db, $req, [":id_chapitre"=>$id_chap, ":id_elt"=>$id]);
                ...
                <div class="col" style="height:90%;">
                    ...
                    <div class="row" style="height:85%; margin-bottom:2vh;">
                        <div id="div_textarea" style="max-width:100%; height:100%;">
                            <textarea id="texte" style="width:100%; height:100%; border: 1px solid grey;" placeholder="Ecrire son texte ici" onkeyup="key_compile();"><?php echo  html_entity_decode(str_replace("<br />", "\n", $texte)); ?></textarea>
                        </div>
                        <div id="div_result">
